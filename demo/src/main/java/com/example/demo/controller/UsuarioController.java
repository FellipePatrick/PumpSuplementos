...
public class UsuarioController {
    ...
    // Lstagem de todos os usuarios está comentado pois não é necessário para o projeto
    // @GetMapping
    ...
    private UsuarioResponseDTO convertToDto(Usuario created) {
      ...
      private Usuario convertToEntity(UsuarioRequestDTO usuario) {
        ...
        String password = e.encode(usuario.getPassword());
        entityPessoa.setPassword(password);
