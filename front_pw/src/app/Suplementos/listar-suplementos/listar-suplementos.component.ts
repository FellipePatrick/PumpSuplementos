...
@Component({
  ...
  standalone: true,
  imports: [MatTableModule, AsyncPipe, MatSnackBarModule],
...
export class ListarSuplementosComponent {
  ...
  displayedColumns = ['nome', 'quantidade', 'imageUri', 'preco', 'descricao', 'categoria'];
  constructor(private produtosService: SuplementosServiceService, public snackBar: MatSnackBar) {
